...
/**
 * <h1>AmazonViewer</h1>
 * AmazonViewer will let the user check up Movies, Series and Chapters in our database.
 * It will also let you look up to Books and MAgazines too. It also builds up daily reports!
 * <p>
 * There are some build in rules that you must follow and read (with a little exception of
 * the Magazine section that just can be seen as exposition.
 * 
